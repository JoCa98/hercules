...
class ConsultAdmin extends Component {
    constructor(props) {
        ...
        */
        ...
        this.deleteAdminMethod = this.deleteAdminMethod.bind(this);
        ...
        return (
            <div className="container">
                ...
                <Breadcrumb>
                        ...
                        <Breadcrumb.Item>Consultar administrador</Breadcrumb.Item>
                    </Breadcrumb>
                </div>
                <div className="row mt-2 card p-5" >
                    <div className="col-12">
                        <h1 className="text-left">Consulta de administrador</h1>
                        <div className="row">
                            <div className="col-8">
                            ...
                            <div className="col-4">
                                <div className="form-group" align="left">
                                    ...
                                    <br></br>
                                    <br></br>
                                    <button className="circularButton w-100" id="DeleteAdminStatus" name="DeleteAdminStatus" onClick={this.deleteAdminMethod}>Eliminar administrador</button>
                                </div>
                            </div>
                        </div>
                        <div className="row">
