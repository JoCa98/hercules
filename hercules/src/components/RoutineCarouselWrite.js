    ...
    */
    ...
    editExercise(event) {
        if (this.state.exist) {
            ...
            this.modalTrigger(event,'Ejercicio','Se ha editado con éxito');                                             
        } else {
            this.modalTrigger(event,'Ejercicio','El elemento no se encuentra');                                                     
        }
    ...
    deleteExercise(event) {
        if (this.state.exist) {
            ...
            this.modalTrigger(event,'Ejercicio','Se ha eliminado con éxito');                                                                 
        } else {
            this.modalTrigger(event,'Ejercicio','El elemento no se encuentra');                                                                 
        }
    ...
    addExercise(event) {
        if (document.getElementById("weightInput") !== "" && document.getElementById("seriesInput") !== ""
            ...
            var obj = {
                exerciseID: this.state.exerciseID, minutes: document.getElementById("minutesInput").value,
            ...
            if (this.state.exist) {
                this.modalTrigger(event,'Ejercicio','El ejercicio ya fue agregado');                                                                                 
            } else {
                this.state.list.push(obj);
                this.modalTrigger(event,'Ejercicio','El ejercicio ha sido agregado con éxito');                                                                                                 
            }
        }
